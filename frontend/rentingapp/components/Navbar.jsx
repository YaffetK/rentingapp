    ...
    return <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 ">
        <div className="container flex flex-wrap items-center justify-between mx-auto w-full">
            ...
            <div className="hidden w-full md:block md:w-auto">
                <ul className="flex justify-between w-full p-4 mt-4 border border-gray-100 rounded-lg bg-grays md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
